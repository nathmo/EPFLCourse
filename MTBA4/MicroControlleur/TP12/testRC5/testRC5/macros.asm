 ...
 *  Author	R.Holzer (adapted MICRO210/EE208 A.Schmid)
 */ 
...
.macro DEC2ASCII
; convert unsigned decimal value
; in 	a0	(value to convert)
; out a1 a2 a3 (100, 10, 1)
	...
	ldi	a1,'0'-1		; preload a0 (digit)
	ldi	w,100			; load the "hundreds"
_centaine:	
	inc	a1
	sub	u,w				; subtract 100
	brsh _centaine	; until the result is negative
	add	u,w				; undo the last substraction
	ldi	a2,'0'-1		; preaload a0 (digit)
	ldi	w,10			; load the "tens"
_dizaine:
	inc	a2
	sub	u,w				; subtract 10
	brsh _dizaine	    ; until the result is negative
	add	u,w				; undo the last substraction
	ldi	a3,'0'	
	add	a3,u
.endmacro
