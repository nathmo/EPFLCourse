...
public class CP_TP3Exo1 {

	public static void main(String args[]) {
		System.out.println("Le plus grand nombre entier (long) vaut : " + Long.MaxValue + ".");
		
		System.out.print("Le nombre reel (double) strictement positif le plus proche de zero vaut : "); 
		System.out.println(Double.MinValue + ".");			
		...
		System.out.println("\n3 a la puissance 4 vaut : " + pow(3,4) + ".");
		...
		short court5;
		court5 = court3 + court4;
		court5 = (short)court3 + court4;
		System.out.println("\nUn calcul correct (grâce au cast) : " + court3 + " + " + court4 + " = " + court5 + ".");
